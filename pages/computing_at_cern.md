...
CERN resources are available to be used by people being employed by an
...
**Those receiving approval engage in using these resources ONLY for activities
related to FCC**.
...
the HTCondor-based CERN batch farm. Usage of these resources is controlled by the
...
quota, the following needs to be added to the HTCondor job submit file:
```
...
Dec  2 16:20:16 2025  Dec  3 17:20:10 2025  krbtgt/CERN.CH@CERN.CH
```
...
In case of issues, please raise a question in the appropriate [FCCSW forum](https://fccsw-forum.web.cern.ch).
